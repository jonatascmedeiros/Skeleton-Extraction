...
GLUTAPI void APIENTRY glutSpacemouseMotionFunc (void(*f)(int,int,int,int,int,int));
GLUTAPI void APIENTRY glutSpacemouseButtonFunc (void(*f)(int,int));
GLUTAPI void APIENTRY glutSpacemouseStart (int);
GLUTAPI void APIENTRY glutSpacemouseStop ();

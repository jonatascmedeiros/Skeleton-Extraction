...
extern char * SIVANfactor[];
extern void * SIVANopt_arg[];
extern char * SIVANsolve [];
extern char * SIVANfactorLU[];
/****************************************************************/
...
taucs_ccs_matrix *Mul2SymmetricMatrices(const taucs_ccs_matrix *matA,
...
// Multiplies matA by x and stores the result
// in b. Assumes all memory has been allocated
// and the sizes match; does not make assumptions on matA
void MulMatrixVector(const taucs_ccs_matrix *matA,
					 const taucsType * x,
					 taucsType * b);
